...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    bio: "Frontend & Full-Stack Developer skilled in building scalable, user-focused web applications with React, Angular, Node.js, and cloud technologies. Experienced in AI-assisted software development, leveraging modern coding assistants to accelerate delivery while maintaining high-quality, production-ready code. Strong problem-solver with a track record of impactful, efficiency-boosting work.",
    location: "Israel",
  ...
  experience: [
    {
      ...
      description: "Full-stack developer on LeadTrap, an AI-powered intake and lead-generation platform serving 100+ ABA healthcare providers. Shipping new product features daily across the frontend and backend, using AI-assisted development to deliver high-quality, production-ready work faster.",
      achievements: [
        ...
        "Leveraging AI-assisted development and modern coding assistants to accelerate delivery while maintaining production-ready code",
        "Contributing across the product — from UI and APIs to CRM integrations with HubSpot, GoHighLevel, Zoho, and ClickUp",
      ],
      technologies: ["TypeScript", "Node.js", "React", "Full-Stack Development", "AI-Assisted Development", "REST APIs", "CRM Integrations"],
