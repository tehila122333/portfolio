  ...
  experience: [
    {
      ...
      description: "Full-stack development on LeadTrap, an AI-powered intake and lead-generation platform serving 100+ ABA healthcare providers. Building core product features across a modern TypeScript stack while leveraging AI development tools like Claude Code to ship reliable, high-quality CRM integrations faster.",
      achievements: [
        "Building core features for an AI-powered platform that automates lead qualification, follow-ups, and insurance capture",
        "Developing and scaling the CRM integrations layer connecting HubSpot, GoHighLevel, Zoho, and ClickUp",
        "Leveraging AI development tools like Claude Code to accelerate delivery without compromising code quality",
        "Helping deliver an AI-driven platform trusted by 100+ healthcare providers",
      ],
      technologies: ["TypeScript", "Node.js", "React", "Claude Code", "AI-Assisted Development", "REST APIs", "CRM Integrations (HubSpot, GHL, Zoho, ClickUp)"],
