...
export default function AskSection() {
  ...
  useEffect(() => {
    // Skip scroll on initial mount to prevent page jumping to Ask section
  ...
  return (
    <div>
      ...
      {/* Chat messages */}
      <div className="border border-[var(--border-subtle)] rounded-xl bg-gradient-to-br from-[var(--surface-dark)] to-[#0a0a0d] mb-6 h-[400px] overflow-y-auto p-6 flex flex-col">
